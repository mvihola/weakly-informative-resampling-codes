...
p = twinplot(p1, p2)
savefig(p, "$(prefix)_normalising_constant_64.pdf")
...
p = twinplot(p1, p2)
savefig(p, "$(prefix)_normalising_constant_512.pdf")
...
p = twinplot(p1, p2)
savefig(p, "$(prefix)_normalising_constant_varying_N.pdf")
...
savefig(p, "$(prefix)_filtering_512.pdf")
...
p = twinplot(p1, p2) 
savefig(p, "$(prefix)_smoothing_512.pdf")
...
p = twinplot(p1, p2) 
savefig(p, "$(prefix)_filtering_smoothing_512.pdf")
...
savefig(p, "$(prefix)_filtering_smoothing_varying_Ns.pdf")
